...
curl -fsSL https://raw.githubusercontent.com/codetesla51/barrage/main/install.sh | bash -s -- --version v0.6.2 --dir ~/.local/bin
...
5. **Every break here was latency, not errors** — success held 98–100%.
   ...
   failed.
6. **Label the failure, don't guess it (v0.6.2).** Capacity-step exports
